<%@ Page Title="" Language="C#" MasterPageFile="~/UcMasterPage.Master" AutoEventWireup="true"
    CodeBehind="users.aspx.cs" Inherits="UcentrikWeb.dirAdmin.users" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="TitlePlaceHolder" runat="server">
    <ucentrik:Title ID="PageTitle" runat="server" Title="Users" />
</asp:Content>
<asp:Content ID="Content3" ContentPlaceHolderID="OperatingPlaceHolder" runat="server">
    <ucentrik:User ID="sosUser" runat="server" UcDataSourceSelectMethod="GetUsersByRole"
        AllowDelete="true" ReadOnly="false" SortExpression="date_last_login" SortDirection="Descending" />
</asp:Content>
