<%@ Page Title="" Language="C#" MasterPageFile="~/UcMasterPage.Master" AutoEventWireup="true"
    CodeBehind="agents.aspx.cs" Inherits="UcentrikWeb.dirAdmin.agents" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="OperatingPlaceHolder" runat="server">
    <asp:MultiView ID="mvAgent" runat="server" ActiveViewIndex="0" >
        <asp:View ID="ViewGroupList" runat="server">
            <ucentrik:Agent ID="sosAgent" runat="server" UcDataSourceSelectMethod="GetAllAgents"
                AllowDelete="true" AllowManagement="true" ReadOnly="false" SortExpression="full_name"
                SortDirection="Ascending" OnManageGroups="sosAgent_ManageGroups" OnManageSkills="sosAgent_ManageSkills"
        ...
        <asp:View ID="ViewAgentGroupList" runat="server">
            <ucentrik:AgentGroup ID="AgentGroup" runat="server" UcDataSourceSelectMethod="GetAllAgentGroups"
                SortExpression="group_name" SortDirection="Ascending" OnBackToList="sosAgent_Back" />
        </asp:View>
