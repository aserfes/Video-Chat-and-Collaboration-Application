<%@ Page Title="" Language="C#" MasterPageFile="~/UcMasterPage.Master" AutoEventWireup="true" CodeBehind="account.aspx.cs" Inherits="UCENTRIK.WEB.PLATFORM.dirCommon.account" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="TitlePlaceHolder" runat="server">
    <ucentrik:Title ID="PageTitle" runat="server" Title="User Account" />
</asp:Content>
