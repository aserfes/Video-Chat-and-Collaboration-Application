...
{
    public partial class IncidentQueue : UcAppBasePage
    {
        ...
        //protected void setCurrentIncidentId(Int32 currentIncidentId)
        //{
        //    ((UcMasterPage)this.Master).SetCurrentIncidentId(currentIncidentId);
        //}

        protected bool openIncident(Int32 incidentId, Int32 agentId, out string msg)
        {
            bool success = IncidentPlatformHelper.OpenIncident(incidentId, agentId, out msg);
            if (success)
            {
