<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="AgentLanguages.ascx.cs" Inherits="UcentrikWeb.App_Controls.BusinessControls.AgentLanguages" %>
    ...
    <tr>
        <td align="center" valign="top" colspan="2">
            ...
            <asp:GridView id="gvList" runat="server"
                DataKeyNames="language_id, agent_id"
