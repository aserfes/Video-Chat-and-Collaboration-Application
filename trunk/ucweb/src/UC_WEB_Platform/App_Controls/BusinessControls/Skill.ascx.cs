...
{
    public partial class Skill : UcAppBaseOperationalControl
    {
        ...
        protected void gvList_RowEditing(object sender, GridViewEditEventArgs e)
        {
            ...
            profileControl.SkillId = _id;

            mvControl.ActiveViewIndex = 1;
            e.Cancel = true;
        }

        protected void lbSkill_Click(object sender, EventArgs e)
        {
        ...
        protected void viewEdit_Save(object sender, UcControlArgs e)
        {
            if (e.IsNew)
            {
                ...
                this.profileControl.SkillId = e.Id;
            }
            else
            {
