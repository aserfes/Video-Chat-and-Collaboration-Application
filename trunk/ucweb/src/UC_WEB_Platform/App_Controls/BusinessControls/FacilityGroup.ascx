<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="FacilityGroup.ascx.cs" Inherits="UcentrikWeb.App_Controls.BusinessControls.FacilityGroup" %>
          ...
          <asp:ObjectDataSource ID="objectdatasourceList" Runat="server"
            TypeName="UCENTRIK.LIB.BllProxy.BllProxyFacilityGroup"
            SelectMethod=""
            DeleteMethod=""
    ...
    <tr>
        <td align="center" valign="top" colspan="2">
            ...
            <asp:GridView id="gvList" runat="server"
                DataKeyNames="group_id, facility_id"
                    ...
                    <asp:TemplateField
                        ...
                        <ItemTemplate>
                            ...
                            <asp:CheckBox ID="chkboxInGroup" runat="server"
                                Enabled="false"
                                Checked='<%# !(Eval("facility_id") is System.DBNull) %>'
                            />
