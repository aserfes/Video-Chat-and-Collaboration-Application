<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="Language.ascx.cs" Inherits="UCENTRIK.WEB.PLATFORM.App_Controls.BusinessControls.Language" %>

<%@ Register TagPrefix="ucentrik" TagName="LanguageProfile" Src="LanguageProfile.ascx" %>
...
<asp:MultiView ID="mvControl" runat="server" ActiveViewIndex="0">
                ...
                <td align="center" colspan="2">
                    ...
                    <asp:GridView id="gvList" runat="server"
                        ...
                        <columns>
                            ...
                            <asp:boundfield datafield="language_name"
                                headertext="Skill" 
                                HeaderStyle-HorizontalAlign="Left"
                                readonly="true"
                                SortExpression="language_name"
    ...
    <asp:View ID="viewEdit" runat="server">
        ...
        <table width="100%" height="100%" cellpadding="0" cellspacing="0" border="0">
            <tr>
                <td valign="top">
                    <ucentrik:LanguageProfile ID="profileControl" runat="server"
