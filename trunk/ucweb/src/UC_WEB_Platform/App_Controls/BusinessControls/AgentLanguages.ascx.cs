...
{
    public partial class AgentLanguages : UcAppBaseLiteControl
    {
        ...
        protected void setAgentLanguages(Int32 _agentId)
        {
            this.UcDataBind();
        }
            ...
            if (row.RowType == DataControlRowType.DataRow)
            {
                ...
                foreach (Control cntrl in row.Cells[lastCell].Controls)
                {
                    ...
                    if (lb != null)
                    {
                        ...
                        {
                            lb.Enabled = index;
                            lb.Attributes.Add("onclick", "return confirm('Do you want to add the language?');");
                        }

                        if (lb.CommandName == "Delete")
                        {
                            lb.Enabled = !index;
                            lb.Attributes.Add("onclick", "return confirm('Do you want to remove the language?');");
                        }
                    }
        ...
        protected void gvList_RowEditing(object sender, GridViewEditEventArgs e)
        {
            ...
            BllProxyLanguageAgent.SetLanguageAgent(_id, agentId, true);

            setAgentLanguages(agentId);
            this.showTextMessage("Language has been added");
        ...
        protected void gvList_RowDeleting(object sender, GridViewDeleteEventArgs e)
        {
            ...
            BllProxyLanguageAgent.SetLanguageAgent(_id, agentId, false);

            setAgentLanguages(agentId);
            this.showTextMessage("Language has been removed");
