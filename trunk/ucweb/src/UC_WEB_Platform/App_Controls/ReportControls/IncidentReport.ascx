<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="IncidentReport.ascx.cs" Inherits="SosWeb.App_Controls.ReportControls.IncidentReport" %>
...
>
    ...
    <table width="100%" height="100%" cellpadding="0" cellspacing="5" border="1">
                ...
                >
                    ...
                    >
                        ...
                        <LocalReport
                            ...
                            ReportPath="App_Core/Reports/IncidentReport.rdlc"
                        >
                        </LocalReport>
