<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="SurveyAverageReport.ascx.cs" Inherits="SosWeb.App_Controls.ReportControls.SurveyAverageReport" %>
        ...
        <tr>
            <td align="center" valign="top" class="ReportBackground">
                ...
                >
                    ...
                    >
                        <LocalReport
                            DisplayName="Survey Average Report"
                            ReportPath="App_Core/Reports/SurveyAverageReport.rdlc"
                        >
                        </LocalReport>
                    </rsweb:ReportViewer>
