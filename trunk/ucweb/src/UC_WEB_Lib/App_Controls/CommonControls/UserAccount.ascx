<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="UserAccount.ascx.cs" Inherits="UCENTRIK.WEB.LIB.App_Controls.CommonControls.UserAccount" %>
            ...
            <tr>
                <td colspan="2">
                    ...
                    <asp:DetailsView ID="dvControl" runat="server"
                        DataKeyNames="user_id, user_role_id"
                            ...
                            <asp:TemplateField HeaderText="TimeZone"
                              Visible="true">
                                ...
                                <EditItemTemplate>
                                    ...
                                    <asp:RequiredFieldValidator ID="rfvTimeZone"
                                      runat="server"
                                        ControlToValidate="ddlTimeZone"
                                        ValidationGroup="Edit"
                                        ErrorMessage="Required Field"
                                        >
                                        Required
