...
<asp:Panel ID="pnlSignIn" runat="server" Visible="false">
                        ...
                        <td width="50%" align="right" Class="UcLink">
                         <%--   <asp:HyperLink ID="hlSignIn" runat="server"
                                NavigateUrl="../../dirCommon/ucSignIn.aspx"
                                CssClass="UcLink"
                            >
                            Sign in
                            </asp:HyperLink>--%>
                    ...
                    <table width="250px" height="22px" cellpadding="0" cellspacing="0" border="0">
                        <tr>
                            ...
                            <td align="right" Class="UcLink">
                                ...
                                <asp:Panel ID="pnlPasswordRecovery" runat="server"
                                    Visible="false"
                                >


                                    <asp:HyperLink ID="hplPasswordRecovery" runat="server"
                                        NavigateUrl="../../dirCommon/ucPasswordRecovery.aspx"
                                        CssClass="UcLink"
                                    >
                                    Forgotten Password?
                                    </asp:HyperLink>
